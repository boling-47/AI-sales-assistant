...
if file:
    ...
    if st.button("开始分析"):
        ...
        with col1:
            ...
            fig_sales.write_image("sales_chart.png")
        ...
        with col2:
            ...
            fig_money.write_image("money_chart.png")
        ...
        def create_word_report(text):
            ...
            doc.add_picture("money_chart.png", width=Inches(5))
            doc.add_picture("pie_chart.png", width=Inches(5))
            doc.add_picture("line_chart.png", width=Inches(5))
